...
class MyMainWindow(QMainWindow,Ui_PyQT_IFX_VR14.Ui_MainWindow):
    def __init__(self,parent=None):
        ...
        self.comboBox_18.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_21.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_20.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_49.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_51.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_52.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_54.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        self.comboBox_56.currentIndexChanged.connect(self.setwp_change_vid_selection_function)
        
        #self.comboBox_24.currentIndexChanged.connect(self.turn_off_check_button_function)
        
        #set command list in comboBox of Vector
        command_list=['setVIDfast', 'setVIDslow', 'setVIDdecay', 'setPS', 'setRegaddr', 'setREGdata', 'getREG', 'testMode','setWP']
    ...
    def set_wp_vector_function(self):
        ...
        if self.checkBox.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_60.text())*1000, str(self.comboBox_23.currentText()))
        ...
        if self.checkBox_7.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_62.text())*1000, str(self.comboBox_25.currentText()))
        ...
        if self.checkBox_8.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_64.text())*1000, str(self.comboBox_26.currentText()))
        ...
        if self.checkBox_9.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_66.text())*1000, str(self.comboBox_27.currentText()))
        ...
        if self.checkBox_17.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_68.text())*1000, str(self.comboBox_28.currentText()))
            item_5_payload_data=int(temp,16)
            item_5_delay=int(self.lineEdit_80.text())
            item_5_svid_addr, item_5_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_18.currentText())
            if self.comboBox_19.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_5_svid_addr,SVID_command=(self.comboBox_19.currentIndex()+1),SVID_payload=item_5_payload_data,SVID_delay=item_5_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_5_svid_addr,SVID_command=(self.comboBox_19.currentIndex()+1),SVID_payload=int(self.lineEdit_67.text(),16),SVID_delay=item_5_delay)
            vector_index+=1
            
          #vector item_6   
        if self.checkBox_18.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_70.text())*1000, str(self.comboBox_29.currentText()))
            item_6_payload_data=int(temp,16)
            item_6_delay=int(self.lineEdit_84.text())
            item_6_svid_addr, item_6_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_21.currentText())
            if self.comboBox_22.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_6_svid_addr,SVID_command=(self.comboBox_22.currentIndex()+1),SVID_payload=item_6_payload_data,SVID_delay=item_6_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_6_svid_addr,SVID_command=(self.comboBox_22.currentIndex()+1),SVID_payload=int(self.lineEdit_69.text(),16),SVID_delay=item_6_delay)
            vector_index+=1

          #vector item_7  
        if self.checkBox_19.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_72.text())*1000, str(self.comboBox_30.currentText()))
            item_7_payload_data=int(temp,16)
            item_7_delay=int(self.lineEdit_82.text())
            item_7_svid_addr, item_7_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_20.currentText())
            if self.comboBox_37.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_7_svid_addr,SVID_command=(self.comboBox_37.currentIndex()+1),SVID_payload=item_7_payload_data,SVID_delay=item_7_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_7_svid_addr,SVID_command=(self.comboBox_37.currentIndex()+1),SVID_payload=int(self.lineEdit_71.text(),16),SVID_delay=item_7_delay)
            vector_index+=1
            
          #vector item_8 
        if self.checkBox_29.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_98.text())*1000, str(self.comboBox_31.currentText()))
            item_8_payload_data=int(temp,16)
            item_8_delay=int(self.lineEdit_113.text())
            item_8_svid_addr, item_8_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_49.currentText())
            if self.comboBox_48.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_8_svid_addr,SVID_command=(self.comboBox_48.currentIndex()+1),SVID_payload=item_8_payload_data,SVID_delay=item_8_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_8_svid_addr,SVID_command=(self.comboBox_48.currentIndex()+1),SVID_payload=int(self.lineEdit_97.text(),16),SVID_delay=item_8_delay)
            vector_index+=1
            
          #vector item_9
        if self.checkBox_30.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_99.text())*1000, str(self.comboBox_32.currentText()))
            item_9_payload_data=int(temp,16)
            item_9_delay=int(self.lineEdit_114.text())
            item_9_svid_addr, item_9_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_51.currentText())
            if self.comboBox_50.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_9_svid_addr,SVID_command=(self.comboBox_50.currentIndex()+1),SVID_payload=item_9_payload_data,SVID_delay=item_9_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_9_svid_addr,SVID_command=(self.comboBox_50.currentIndex()+1),SVID_payload=int(self.lineEdit_100.text(),16),SVID_delay=item_9_delay)
            vector_index+=1

          #vector item_10
        if self.checkBox_31.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_102.text())*1000, str(self.comboBox_33.currentText()))
            item_10_payload_data=int(temp,16)
            item_10_delay=int(self.lineEdit_112.text())
            item_10_svid_addr, item_10_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_52.currentText())
            if self.comboBox_53.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_10_svid_addr,SVID_command=(self.comboBox_53.currentIndex()+1),SVID_payload=item_10_payload_data,SVID_delay=item_10_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_10_svid_addr,SVID_command=(self.comboBox_53.currentIndex()+1),SVID_payload=int(self.lineEdit_101.text(),16),SVID_delay=item_10_delay)
            vector_index+=1

          #vector item_11
        if self.checkBox_32.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_103.text())*1000, str(self.comboBox_34.currentText()))
            item_11_payload_data=int(temp,16)
            item_11_delay=int(self.lineEdit_116.text())
            item_11_svid_addr, item_11_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_54.currentText())
            if self.comboBox_55.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_11_svid_addr,SVID_command=(self.comboBox_55.currentIndex()+1),SVID_payload=item_11_payload_data,SVID_delay=item_11_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_11_svid_addr,SVID_command=(self.comboBox_55.currentIndex()+1),SVID_payload=int(self.lineEdit_104.text(),16),SVID_delay=item_11_delay)
            vector_index+=1
            
          #vector item_12
        if self.checkBox_33.isChecked()==1:
            temp=ifx.VID_10mV_to_hex(float(self.lineEdit_106.text())*1000, str(self.comboBox_35.currentText()))
            item_12_payload_data=int(temp,16)
            item_12_delay=int(self.lineEdit_115.text())
            item_12_svid_addr, item_12_svid_bus=ifx.rail_name_to_svid_parameter(self.comboBox_56.currentText())
            if self.comboBox_57.currentIndex()<=1:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_12_svid_addr,SVID_command=(self.comboBox_56.currentIndex()+1),SVID_payload=item_12_payload_data,SVID_delay=item_12_delay)
            else:
                IFX_set_wp.add_vector_into_vector(index=vector_index,SVID_address=item_12_svid_addr,SVID_command=(self.comboBox_56.currentIndex()+1),SVID_payload=int(self.lineEdit_105.text(),16),SVID_delay=item_12_delay)
            vector_index+=1
            ...
            if self.tabWidget.currentIndex() == 0:
                ...
                if dlg.exec_():
                    ...
                    with open(filenames[0],'r') as j:
                        json_data=json.load(j)
                        print(json_data)
                    self.comboBox_2.setCurrentText(json_data["set_wp_init_rail_name1"])
                    self.comboBox_3.setCurrentText(json_data["set_wp_init_rail_name2"])
                    self.comboBox_4.setCurrentText(json_data["set_wp_init_rail_name3"])
                    self.comboBox_5.setCurrentText(json_data["set_wp_init_rail_name4"])
                    self.lineEdit_20.setText(json_data["set_wp_init_rail_name1_wp1"])
                    self.lineEdit_21.setText(json_data["set_wp_init_rail_name1_wp2"])
                    self.lineEdit_23.setText(json_data["set_wp_init_rail_name2_wp1"])
                    self.lineEdit_24.setText(json_data["set_wp_init_rail_name2_wp2"])
                    self.lineEdit_26.setText(json_data["set_wp_init_rail_name3_wp1"])
                    self.lineEdit_27.setText(json_data["set_wp_init_rail_name3_wp2"])
                    self.lineEdit_29.setText(json_data["set_wp_init_rail_name4_wp1"])
                    self.lineEdit_30.setText(json_data["set_wp_init_rail_name4_wp1"])
                    self.comboBox_6.setCurrentText(json_data["set_wp_init_rail_vid_table1"])
                    self.comboBox_7.setCurrentText(json_data["set_wp_init_rail_vid_table2"])
                    self.comboBox_8.setCurrentText(json_data["set_wp_init_rail_vid_table3"])
                    self.comboBox_9.setCurrentText(json_data["set_wp_init_rail_vid_table4"])
                    
                    self.checkBox.setChecked(json_data["set_wp_vector_line1_checked"])
                    self.checkBox_7.setChecked(json_data["set_wp_vector_line2_checked"])
                    self.checkBox_8.setChecked(json_data["set_wp_vector_line3_checked"])
                    self.checkBox_9.setChecked(json_data["set_wp_vector_line4_checked"])
                    self.checkBox_17.setChecked(json_data["set_wp_vector_line5_checked"])
                    self.checkBox_18.setChecked(json_data["set_wp_vector_line6_checked"])
                    self.checkBox_19.setChecked(json_data["set_wp_vector_line7_checked"])
                    self.checkBox_29.setChecked(json_data["set_wp_vector_line8_checked"])
                    self.checkBox_30.setChecked(json_data["set_wp_vector_line9_checked"])
                    self.checkBox_31.setChecked(json_data["set_wp_vector_line10_checked"])
                    self.checkBox_32.setChecked(json_data["set_wp_vector_line11_checked"])
                    self.checkBox_33.setChecked(json_data["set_wp_vector_line12_checked"])
                    self.comboBox_10.setCurrentText(json_data["set_wp_vector_line1_railname"])
                    self.comboBox_12.setCurrentText(json_data["set_wp_vector_line2_railname"])
                    self.comboBox_14.setCurrentText(json_data["set_wp_vector_line3_railname"])
                    self.comboBox_16.setCurrentText(json_data["set_wp_vector_line4_railname"])
                    self.comboBox_18.setCurrentText(json_data["set_wp_vector_line5_railname"])
                    self.comboBox_21.setCurrentText(json_data["set_wp_vector_line6_railname"])
                    self.comboBox_20.setCurrentText(json_data["set_wp_vector_line7_railname"])
                    self.comboBox_49.setCurrentText(json_data["set_wp_vector_line8_railname"])
                    self.comboBox_51.setCurrentText(json_data["set_wp_vector_line9_railname"])
                    self.comboBox_52.setCurrentText(json_data["set_wp_vector_line10_railname"])
                    self.comboBox_54.setCurrentText(json_data["set_wp_vector_line11_railname"])
                    self.comboBox_56.setCurrentText(json_data["set_wp_vector_line12_railname"])
                    self.comboBox_11.setCurrentText(json_data["set_wp_vector_line1_command"])
                    self.comboBox_13.setCurrentText(json_data["set_wp_vector_line2_command"])
                    self.comboBox_15.setCurrentText(json_data["set_wp_vector_line3_command"])
                    self.comboBox_17.setCurrentText(json_data["set_wp_vector_line4_command"])
                    self.lineEdit_59.setText(json_data["set_wp_vector_line1_payload"])
                    self.lineEdit_61.setText(json_data["set_wp_vector_line2_payload"])
                    self.lineEdit_63.setText(json_data["set_wp_vector_line3_payload"])
                    self.lineEdit_65.setText(json_data["set_wp_vector_line4_payload"])
                    self.lineEdit_67.setText(json_data["set_wp_vector_line5_payload"])
                    self.lineEdit_69.setText(json_data["set_wp_vector_line6_payload"])
                    self.lineEdit_71.setText(json_data["set_wp_vector_line7_payload"])
                    self.lineEdit_97.setText(json_data["set_wp_vector_line8_payload"])
                    self.lineEdit_100.setText(json_data["set_wp_vector_line9_payload"])
                    self.lineEdit_101.setText(json_data["set_wp_vector_line10_payload"])
                    self.lineEdit_104.setText(json_data["set_wp_vector_line11_payload"])
                    self.lineEdit_105.setText(json_data["set_wp_vector_line12_payload"])
                    self.lineEdit_60.setText(json_data["set_wp_vector_line1_payload_voltage"])
                    self.lineEdit_62.setText(json_data["set_wp_vector_line2_payload_voltage"])
                    self.lineEdit_64.setText(json_data["set_wp_vector_line3_payload_voltage"])
                    self.lineEdit_66.setText(json_data["set_wp_vector_line4_payload_voltage"])
                    self.lineEdit_68.setText(json_data["set_wp_vector_line5_payload_voltage"])
                    self.lineEdit_70.setText(json_data["set_wp_vector_line6_payload_voltage"])
                    self.lineEdit_72.setText(json_data["set_wp_vector_line7_payload_voltage"])
                    self.lineEdit_98.setText(json_data["set_wp_vector_line8_payload_voltage"])
                    self.lineEdit_99.setText(json_data["set_wp_vector_line9_payload_voltage"])
                    self.lineEdit_102.setText(json_data["set_wp_vector_line10_payload_voltage"])
                    self.lineEdit_103.setText(json_data["set_wp_vector_line11_payload_voltage"])
                    self.lineEdit_106.setText(json_data["set_wp_vector_line12_payload_voltage"])
                    self.comboBox_23.setCurrentText(json_data["set_wp_vector_line1_vid_table"])
                    self.comboBox_25.setCurrentText(json_data["set_wp_vector_line2_vid_table"])
                    self.comboBox_26.setCurrentText(json_data["set_wp_vector_line3_vid_table"])
                    self.comboBox_27.setCurrentText(json_data["set_wp_vector_line4_vid_table"])
                    self.comboBox_28.setCurrentText(json_data["set_wp_vector_line5_vid_table"])
                    self.comboBox_29.setCurrentText(json_data["set_wp_vector_line6_vid_table"])
                    self.comboBox_30.setCurrentText(json_data["set_wp_vector_line7_vid_table"])
                    self.comboBox_31.setCurrentText(json_data["set_wp_vector_line8_vid_table"])
                    self.comboBox_32.setCurrentText(json_data["set_wp_vector_line9_vid_table"])
                    self.comboBox_33.setCurrentText(json_data["set_wp_vector_line10_vid_table"])
                    self.comboBox_34.setCurrentText(json_data["set_wp_vector_line11_vid_table"])
                    self.comboBox_35.setCurrentText(json_data["set_wp_vector_line12_vid_table"])
                    self.lineEdit_81.setText(json_data["set_wp_vector_line1_delay"])
                    self.lineEdit_86.setText(json_data["set_wp_vector_line2_delay"])
                    self.lineEdit_85.setText(json_data["set_wp_vector_line3_delay"])
                    self.lineEdit_83.setText(json_data["set_wp_vector_line4_delay"])
                    self.lineEdit_80.setText(json_data["set_wp_vector_line5_delay"])
                    self.lineEdit_84.setText(json_data["set_wp_vector_line6_delay"])
                    self.lineEdit_82.setText(json_data["set_wp_vector_line7_delay"])
                    self.lineEdit_113.setText(json_data["set_wp_vector_line8_delay"])
                    self.lineEdit_114.setText(json_data["set_wp_vector_line9_delay"])
                    self.lineEdit_112.setText(json_data["set_wp_vector_line10_delay"])
                    self.lineEdit_116.setText(json_data["set_wp_vector_line11_delay"])
                    self.lineEdit_115.setText(json_data["set_wp_vector_line12_delay"])
                    self.lineEdit_58.setText(json_data.get("set_wp_loop_times", '0'))
            else:
                QMessageBox.about(self, "Warning", "It can't support this page")
        except:
                QMessageBox.about(self, "Warning", "The JSON file can't match this page, please select another .JSON file")
